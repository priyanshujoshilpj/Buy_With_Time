...
def signup(request):
    ...
    if request.method == "POST":
        ...
        if len(username)>10:
            messages.error(request, "Username must be under 10characters")
        ...
        subject = "Welcome to our app(Buy with Time!) Login!"
        message = "Hello" + myuser.first_name + "!! \n" + "Welcome to our app(Buy with Time!) \n Thank you for visiting our website \n We have also sent you a confirmation email, please confirm your email address in order to activate your account. \n\n Thanking You."
        ...
        email_subject = "Confirm your email @ Buy With Time!"
